...
public partial class Email : System.Web.UI.Page
{
    ...
    void setDataSource(string condition)
    {
        ...
        DataSet ds = db.Query("select * from tb_email  " + condition);
    ...
    protected void btnRefresh_Click(object sender, EventArgs e)
    {
        ...
        if (!this.txtKeyWord.Text.Trim().Equals("请输入关键字"))
        {
            ...
            {
                condition += " and (Code like '%" + this.txtKeyWord.Text.Trim() + "%'" + "  or  Email like '%" + this.txtKeyWord.Text.Trim() + "%'" + "  or  LoginName like '%" + this.txtKeyWord.Text.Trim() + "%')";
            }
        }
