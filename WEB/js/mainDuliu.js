...
function initCol() {
    ...
    allHtml += " <input type='button' value='预  览' onclick='preview()' style='width:200px;height:50px;' /></div>";
    allHtml += " </div>";
...
function preview() {
    var data = getData();
    window.location.href = "SendOrderDuliu2.aspx?data=" + data + "&user=" + user + "&shop="+shop+"&userid="+myuserid+"&backurl=" + window.location.href;
}
