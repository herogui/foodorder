...
public partial class CaidangFuding : System.Web.UI.Page
{
    ...
    void setDataSource(string condition)
    {
        ...
        DataSet ds = db.Query("select * from tb_dishesFuding  " + condition);
    ...
    protected void gvInfo_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        data.Add("IsAction", "0");
        bool isSuc = db.UpdateDataWkt("tb_dishesFuding", data, " where id = '" + strID + "'");
